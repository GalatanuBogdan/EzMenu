...
INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Clasică Full meat', '40,90', 'img\\PizzaClasicăFullmeat.png', 'Kaizer, piept de pui, salam demisec', 'Kaizer, piept de pui, salam demisec, salam vară, sunca de porc, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat', '900', '1',"[30]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Clasică Mamma mia', '41,90', 'img\\PizzaClasicăMammamia.png', 'Ardei gras, piept de pui, salam demisec', 'Ardei gras, piept de pui, salam demisec, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat, măsline kalamata', '800', '1',"[30]","[1,2,3]");
...
INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Pollo', '37,90', 'img\\PizzaPollo.png', 'Piept de pui, mix branzeturi mamma mia', ' Piept de pui, mix branzeturi mamma mia (cascaval si mozzarella), sos, roșii bruschette (contin usturoi), aluat, măsline kalamata', '800', '1',"[30]","[1,2,3]");
...
INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Italian queen', '39,90', 'img\\PizzaItalianqueen.png', 'Ardei gras, ciuperci, măsline kalamata', ' Ardei gras, ciuperci, măsline kalamata, piept de pui, porumb, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat', '800', '1',"[30]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Clasică Quattro stagioni', '37,90', 'img\\PizzaClasicăQuattrostagioni.png', 'Ardei gras, ciuperci, salam vară', ' Ardei gras, ciuperci, salam vară, sunca de porc, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat', '700', '1',"[30]","[1,2,3]");
