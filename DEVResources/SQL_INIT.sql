...
INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Shawarma sandwich F.G.', '24,90', 'img\\ShawarmasandwichFGs.png', 'Cartofi prăjiţi, lipie, salată de varză', 'Cartofi prăjiţi, lipie, salată de varză, piept de pui uşor picant, castraveti in otet, sos cocktail', '450', '1',"[7]","[2]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Clasică Full meat', '40,90', 'img\\PizzaClasicăFullmeat.png', 'Kaizer, piept de pui, salam demisec', 'Kaizer, piept de pui, salam demisec, salam vară, sunca de porc, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat', '900', '1',"[16]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Clasică Mamma mia', '41,90', 'img\\PizzaClasicăMammamia.png', 'Ardei gras, piept de pui, salam demisec', 'Ardei gras, piept de pui, salam demisec, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat, măsline kalamata', '800', '1',"[16]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Spaghetti Carbonara', '30.90', 'img\\SpaghettiCarbonara.png', 'Smântână, spaghetti, kaiser', 'Smântână, spaghetti, kaiser, specialitate de branza tare ', '400', '1',"[6]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Meniu burger Mammamia', '35,90', 'img\\MeniuburgerMammamia.png', 'Carne de vită, cartofi prăjiţi', 'Carne de vită, cartofi prăjiţi, sos barbeque, kaiser, mix de salate, castraveti in otet, chifla, branza gouda, sos tartar ', '580', '1',"[3]","[1,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Meniu snitel de pui', '31,90', 'img\\Meniusniteldepui.png', 'Cartofi prăjiţi, maioneză cu usturoi', ' Cartofi prăjiţi, maioneză cu usturoi, ouă, pesmet, piept de pui, salata coleslaw', '550', '1',"[7]","[2]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Crispy sandwich F.G.', '23,90', 'img\\CrispysandwichFG.png', 'Cartofi prăjiţi, lipie, piept de pui', ' Cartofi prăjiţi, lipie, piept de pui uşor picant, castraveti in otet, sos cocktail', '400', '1',"[7]","[2]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Clasică Specialitatea casei', '36.90', 'img\\PizzaClasicăSpecialitateacasei.png', 'Ciuperci, kaizer, măsline kalamata', 'Ciuperci, kaizer, măsline kalamata, salam vară, sunca de porc, mix branzeturi mamma mia (cascaval si mozzarella), sos, ardei copţi, aluat', '900', '1',"[16]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Pollo', '37,90', 'img\\PizzaPollo.png', 'Piept de pui, mix branzeturi mamma mia', ' Piept de pui, mix branzeturi mamma mia (cascaval si mozzarella), sos, roșii bruschette (contin usturoi), aluat, măsline kalamata', '800', '1',"[16]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Meniu shawarma', '31,90', 'img\\Meniushawarma.png', 'Cartofi prăjiţi, maioneză cu usturoi', ' Cartofi prăjiţi, maioneză cu usturoi, piept de pui uşor picant, salata coleslaw', '550', '1',"[7]","[2]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Clasică Prosciutto funghi salami', '34,90', 'img\\PizzaClasicăProsciuttofunghisalami.png', 'Ciuperci, salam vară, sunca de porc', ' Ciuperci, salam vară, sunca de porc, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat', '750', '1',"[16]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Italian queen', '39,90', 'img\\PizzaItalianqueen.png', 'Ardei gras, ciuperci, măsline kalamata', ' Ardei gras, ciuperci, măsline kalamata, piept de pui, porumb, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat', '800', '1',"[16]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pizza Clasică Quattro stagioni', '37,90', 'img\\PizzaClasicăQuattrostagioni.png', 'Ardei gras, ciuperci, salam vară', ' Ardei gras, ciuperci, salam vară, sunca de porc, mix branzeturi mamma mia (cascaval si mozzarella), sos, aluat', '700', '1',"[16]","[1,2,3]");

INSERT INTO product ( restaurantID, title, price, imageURL, previewDescription , description, cantity, disponibility,categories,allergens) VALUES ( '1', 'Pui vienez', '34,90', 'img\\Puivienez.png', 'Ceapă albă, ciuperci, piept de pui', 'Ceapă albă, ciuperci, piept de pui, smântână, cartofi, mix branzeturi mamma mia (cascaval si mozzarella)', '400', '1',"[7, 12]","[1]");
-- //tabels MammaMia
...
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('1','1','MIC DEJUN');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('2','1','CIORBE SI SUPE');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('3','1','BURGERI');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('4','1','SALATE');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('5','1','PREPARATE DE POST/VEGANE');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('6','1','PASTE');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('7','1','PREPARATE DE PUI');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('8','1','PREPARATE DE PORC');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('9','1','PREPARATE DE CURCAN');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('10','1','PREPARATE DE PESTE');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('11','1','BUCĂTĂRIE MEXICANĂ');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('12','1','PREPARATE TRADIȚIONALE');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('13','1','GARNITURI');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('14','1','SOSURI');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('15','1','DESERT');
INSERT INTO `categories` (`ID`, `restaurantID`,`name`) VALUE ('16','1','PIZZA');
